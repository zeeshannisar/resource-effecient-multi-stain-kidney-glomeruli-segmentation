...
if __name__ == '__main__':
    ...
    if args.label:
        ...
        configfilename = glob.glob(os.path.join(config['detector.outputpath'], 'code.*.cfg'))
    ...
    config = config_utils.readconfig(os.path.join(config['detector.outputpath'], 'code.' + label + '_1.cfg'))
