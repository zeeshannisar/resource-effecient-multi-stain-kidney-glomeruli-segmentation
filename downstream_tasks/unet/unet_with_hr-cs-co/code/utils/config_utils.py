...
def readconfig(config_file):
    ...
    configdict['general.workpath']           = config.get('general', 'workpath')
    configdict['general.scratchpath']        = config.get('general', 'scratchpath')
    configdict['general.additionalpath']     = config.get('general', 'additionalpath')
    ...
    # # Additional settings to FineTune the UNet Decoder based on SSL features
    # if configdict['transferlearning.finetune'] and configdict['transferlearning.finetunemode'] == "SSL":
    #     configdict['SSLfinetune.SSLnetwork'] = config.get('SSLfinetune', 'SSLnetwork')
    #     configdict['SSLfinetune.SSLrepetition'] = config.get('SSLfinetune', 'SSLrepetition')
    #     configdict['SSLfinetune.SSLmodelname'] = config.get('SSLfinetune', 'SSLmodelname')
    #     configdict["SSLfinetune.SSLhiddenlayers"] = [int(x) for x in config.get("SSLfinetune", "SSLhiddenlayers").split(',')]
    #     configdict['SSLfinetune.SSLmodelatepoch'] = config.get('SSLfinetune', 'SSLmodelatepoch')
    #     configdict['SSLfinetune.SSLmodelpath'] = config.get('SSLfinetune', 'SSLmodelpath')
    #     configdict['SSLfinetune.SSLdatastatsfile'] = config.get('SSLfinetune', 'SSLdatastatsfile')

    # # Detector
    # configdict['detector.patchstrategy'] = config.get('detector', 'patchstrategy')
    # if configdict['detector.patchstrategy'] == "patientX_percentN":
    #     configdict['detector.patientX'] = config.get('detector', 'patientX')
    #     configdict['detector.percentN'] = config.get('detector', 'percentN')
    # elif configdict['detector.patchstrategy'] == "percentN_randomly":
    #     configdict['detector.percentN'] = config.get('detector', 'percentN')
    # elif configdict['detector.patchstrategy'] == "percentN_equally_randomly":
    #     configdict['detector.percentN'] = config.get('detector', 'percentN')
    # else:
    #     raise ValueError("configdict['detector.patchstrategy'] should be one of ['patientX_percentN', "
    #                      "'percentN_randomly', 'percentN_equally_randomly']")
