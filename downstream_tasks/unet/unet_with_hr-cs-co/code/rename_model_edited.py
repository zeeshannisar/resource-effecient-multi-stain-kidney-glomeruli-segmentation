...
def derived_parameters(conf, arguments):
    conf['detector.patchstrategy'] = args.patch_strategy
    conf['detector.percentN'] = args.percent_N
    ...
    if conf['transferlearning.finetune']:
        conf['transferlearning.pretrained_ssl_model'] = args.pretrained_ssl_model
        conf['transferlearning.pretrained_ssl_model_rep'] = args.pretrained_ssl_model_rep
        conf['transferlearning.pretrained_ssl_model_name'] = args.pretrained_ssl_model_name
        conf['transferlearning.pretrained_ssl_model_at_epoch'] = args.pretrained_ssl_model_at_epoch
